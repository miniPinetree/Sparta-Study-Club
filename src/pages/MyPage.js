...
const MyPage = (props) => {
  ...
  //회원에게 랜덤으로 보이는 멘트.
    const greeting = () => {
        const ment = ['오늘도 달려볼까요?', '천리길도 Hello World 부터!', '코딩할 준비 되셨죠?', '딱 코딩하기 좋은 날씨에요!','어서 시작하러 가봐요!']
          ...
          <ItemBox>
            ...
            {/* 시간 설정 시 더미표시.
                    ...
                    <Mentbox>
                        ...
                        <div>
                        <Text size="18px" margin="-1px 0px 0px 7px" bold><Point>'미송님'</Point> {greeting()}</Text>
