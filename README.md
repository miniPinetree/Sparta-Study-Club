...
달성률과 매일의 퀘스트 내용은 축적되어 최근 5일간의 시간 활용도를 그래프로 확인할 수 있다.
캘린더를 통해 과거 퀘스트 내역과 달성률을 확인할 수 있다. 달성률이 높은 날일수록 색이 진해진다.
실시간 채팅을 통해 다른 유저와 소통할 수 있다.
스터디 클럽에 가입하여 비슷한 목표를 가진 사람들끼리 경쟁하고 랭킹을 확인할 수 있다.
스터디 클럽 게시판에 코멘트를 남길 수 있어 정보 교류와 서로간 동기부여가 가능하다. 
```
### 기간/인원
```
...
(배운 점) 이 역시 1번 개선사례와 같이 사용자와의  나의 의도와 사용자 인식이 다를 수 있다는 것을 알았고 
